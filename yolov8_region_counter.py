...
counting_regions = [
    {
        ...
        "polygon": Polygon([(50, 80), (250, 20), (450, 80)]),  # Polygon points, my
        "counts": 0,
        "dragging": False,
...
def run(
    ...
    while videocapture.isOpened():
        ...
        # results = model.track(frame, persist=True, classes=classes, stream=True)  #my
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default="los_angeles.mp4", required=True, help="video file path")
    parser.add_argument("--view-img", default="show results", action="store_true", help="show results")
